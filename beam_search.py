...
class Hypothesis(object):
    ...
    def __init__(self, tokens, log_probs, state, attn_dists, p_gens, coverage):
        ...
        Args:
          ...
          p_gens: List, same length as tokens, of floats, or None if not using pointer-generator models. The values of the generation probability so far.
