...
def outputids2words(id_list, vocab, article_oovs):
    ...
    for i in id_list:
        try:
            ...
            assert article_oovs is not None, "Error: models produced a word ID that isn't in the vocabulary. This should not happen in baseline (no pointer-generator) mode"
