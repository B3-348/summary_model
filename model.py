...
"""This file contains code to build and run the tensorflow graph for the sequence-to-sequence models"""
...
class SummarizationModel(object):
    """A class to represent a sequence-to-sequence models for text summarization. Supports both baseline mode, pointer-generator mode, and coverage"""
    ...
    def _calc_final_dist(self, vocab_dists, attn_dists):
        """Calculate the final distribution, for the pointer-generator models
    ...
    def _add_seq2seq(self):
        """Add the whole sequence-to-sequence models to the graph."""
        hps = self._hps
        ...
        with tf.variable_scope('seq2seq'):
            ...
            # For pointer-generator models, calc final distribution from copy distribution and vocabulary distribution
            if FLAGS.pointer_gen:
        ...
        def _add_encoder(self, encoder_inputs, seq_len):
            ...
            with tf.variable_scope('encoder'):
                ...
                encoder_outputs = tf.concat(axis=2,
                                            values=encoder_outputs)  # concatenate the forwards and backwards states
            return encoder_outputs, fw_st, bw_st
